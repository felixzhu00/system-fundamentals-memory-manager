...
**Note:** This document outlines the specifications and requirements for the assignment. Adherence to these specifications is crucial for successful completion of the assignment.

**Reference:** The chapters mentioned in this document are from "Bryant and O'Hallaron, Computer Systems: A Programmer's Perspective, third edition, Pearson, 2016".
# Assignment
